...
const project = {
  ...
  "githubUrl": "https://github.com/Justin21523/excel-python-data-analysis",
  ...
  "records": [
    {
      "id": "flow-01",
      "name": "Detected technical signals: Python, pandas, openpyxl, Streamlit, Plotly, pytest, Playwright, Excel,README evidence exists and can support a fuller reviewed case study,A public GitHub repository is linked for source traceability",
      "status": "Ready",
      "owner": "Frontend"
    },
    {
      "id": "flow-02",
      "name": "I refactored the project into a source-based application with reusable IO, profiling, cleaning, analytics, reporting, and dashboard modules",
      "status": "Review",
      "owner": "Data"
    },
    {
      "id": "flow-03",
      "name": "The demo uses synthetic retail workbooks to walk through data quality checks, cleaning, sales/customer/product analysis, Excel report export, and an openpyxl feature showcase",
      "status": "Queued",
      "owner": "Automation"
    }
  ]
